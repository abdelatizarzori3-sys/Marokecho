...
[![Copilot](https://img.shields.io/badge/GitHub%20Copilot-Enabled-8A2BE2)](.github/copilot-instructions.md)

**نظام إدارة الوقت والطاقة الذكي**

[الواجهة الرئيسية](#-الواجهة-الرئيسية) • [التثبيت](#-التثبيت) • [الاستخدام](#-الاستخدام) • [المساعدين](#-المساعدون-المجانيون)
...
## 🤖 المساعدون المجانيون (GitHub Assistants)

تم تجهيز المشروع بمجموعة من **المساعدين المجانية** على GitHub:

| المساعد | الوصف | الحالة |
|---------|-------|--------|
| 🧠 **GitHub Copilot** | مساعد الذكاء الاصطناعي لكتابة الكود | ✅ مفعل |
| 🤖 **GitHub Actions** | اختبارات تلقائية + تنسيق + نشر | ✅ 3 Workflows |
| 📦 **Dependabot** | تحديث تلقائي للمكتبات | ✅ أسبوعي |
| 📝 **Issue Templates** | قوالب تقارير الأخطاء والميزات | ✅ جاهز |
| 🔍 **Auto Format** | تنسيق تلقائي للكود (Black + isort) | ✅ على كل PR |

### 🧠 GitHub Copilot

تم إضافة تعليمات مخصصة للمشروع في `.github/copilot-instructions.md`:
- معايير الكود (Python/HTML/CSS/JS)
- قواعد الأمان
- أسماء الدوال والفئات
- معايير التعليقات

**للتفعيل:**
1. اذهب إلى [GitHub Copilot Settings](https://github.com/settings/copilot)
2. فعّل **Copilot Free** (مجاني تماماً)
3. استخدم في VS Code / JetBrains / Vim

### 🤖 GitHub Actions Workflows

| Workflow | المهمة | التشغيل |
|----------|--------|---------|
| `ci.yml` | اختبارات + فحص أمان + بناء | push, PR |
| `auto-format.yml` | تنسيق تلقائي (Black) | push, PR |
| `release.yml` | نشر إصدار + ZIP | tags (v*) |
...
│   ├── dependabot.yml             # 📦 تحديث تلقائي
│   ├── CODEOWNERS                 # 👥 مسؤولو المراجعة
│   ├── FUNDING.yml                # ☕ دعم المشروع
│   ├── pull_request_template.md   # 📝 قالب PR
│   ├── workflows/
│   │   ├── ci.yml                 # 🔧 CI/CD
│   │   ├── auto-format.yml        # 🎨 تنسيق تلقائي
│   │   └── release.yml            # 🚀 نشر إصدار
│   └── ISSUE_TEMPLATE/
...
5. فتح Pull Request (سيتم تطبيق التنسيق التلقائي)
